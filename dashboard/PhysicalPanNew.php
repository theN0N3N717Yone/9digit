<?php
$pageName = "Request For New PAN Card ( F49A )"; // Replace this with the actual page name
...
if (isset($_POST['new_application']) && !empty($_POST['epan_flag']) && !empty($amount)) {
    ...
    if ($amount > $userdata['balance']) {
        ...
        $mode = 'PAN Creation';
        $type = 'debit';
        $remark = 'Physical Creation Pan Transaction - Requested by: ' . $_POST["name_card"] . ' (UID Number: ' . $aadhaar . ')';
        $status = 'success';
        $userIdd = $userdata['id'];
        ...
        if ($txn->execute()) {
            ...
            $nsdlsql = "INSERT INTO `nsdlpancard`(`web_url`,`order_id`,`type`,`cat_applicant`,`pan_number`,`l_name`, `f_name`, `m_name`, `name_card`, `dob`, `gender`, `fal_name`, `faf_name`, `fam_name`, `aadhaar_num`, `name_aadhaar`, `mob_num`, `email_id`, `address1`, `address2`, `address3`, `address4`, `address5`, `user_state`, `pincode`, `pan_type`, `r_title`, `rl_name`, `rf_name`, `rm_name`, `r_address1`, `r_address2`, `r_address3`, `r_address4`, `r_address5`, `r_state`, `r_pincode`, `city`, `area_code`, `ao_type`, `rangecode`, `aocode`, `proof_id`, `proof_add`, `proof_dob`, `application_type`, `sig_type`, `epan_flag`, `amount`,`balance`, `title`, `user_id`,`date_time`,`timestamp`,`remark`,`status`)
                ...
                $nsdl->bindParam(":pan_number", filter_var($pa,FILTER_SANITIZE_STRING));
                            ...
                            <div class="modal-dialog modal-sm modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-body text-center p-4">
                                        <img style="margin-top: -30px; margin-bottom: -30px;" src="assets/psimg/success.gif" height="150" width="150">
                ...
                echo "<script>
                     Ps_alert('Form submission failed.', 'error');
                     setTimeout(function() {
                    window.location.href = '';
                }, 1500);
                </script>";
...
<form id="msform" class="user" action="" method="POST" onsubmit="return Pan_new();">
     <div style="color:black; background: #f58f2d; panding:5px">
	    <h6 class="text-center p-2"><b style="color: black; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3);">Request For New PAN Card ( F49A ) <br class="mt-1">Applicants has to submit the printed signed application forms at nearest || Under section 139A of the Income-Tax Act, 1961</b></h6>
	</div>
            ...
            <tr>
                <td>
                    <table width="1000px" align="center">
                        <tbody>
                            <tr>
                                <th align="left" style="font-size: small; font-family: Arial; border: none;">Category of Applicant</th>
                                <td>
                                    <select id="cat_applicant" name="cat_applicant" tabindex="1" style="height: 22px" class="errborder active">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <input id="ymother" name="singleParentFlag" tabindex="26" size="25" maxlength="25" disabled="disabled" type="radio" value="Y">Yes 
                                    <input id="nmother" name="singleParentFlag" tabindex="27" size="25" maxlength="25" checked="checked" disabled="disabled" type="radio" value="N">No
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="tel_num_isdcode" name="tel_num_isdcode" style="height: 22px" tabindex="10" type="text" value="+91" maxlength="7" disabled="" autocomplete="off"> -
                                </td>
                                <td>
                                    <input id="tel_num_stdcode" name="tel_num_stdcode" style="height: 22px" tabindex="11" type="text" value="OPTIONAL" maxlength="7" autocomplete="off"> -
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="3" "width:="" 202px"="">
                                    <input class="mt-1" id="email_id" name="email_id" oninput="this.value = this.value.toUpperCase()" onblur="this.value = this.value.toUpperCase();" tabindex="13" style="width: 550px; height: 22px" type="text" value="" required size="92" maxlength="75">
                                </td>
                            </tr>
                            <tr>
                                <th align="left" style="border: none;"></th>
                            ...
                            <tr>
                                <th align="left" style="font-size: small; font-family: Arial; border: none;">Card Dispatched</th>
                                <td align="left">
                            ...
                            <!--- Added for E-Pan:: start---->
                            <tr>
                                <th align="left" style="font-size: small; font-family: Arial; border: none;">Whether you wish to have?</th>
                                <td align="left" colspan="3">
                                    <input class="mt-1" id="y" name="epan_flag" tabindex="26" size="25" maxlength="25" checked="checked" onchange="checkEPAN();" type="radio" value="Y">Physical PAN Card &amp; e-PAN Card &nbsp; <input class="mt-1" id="n" name="epan_flag" tabindex="27" size="35" maxlength="25" onchange="checkEPAN();" type="radio" value="N">Only e-PAN Card (e-mail ID is mandatory)
                                </td>
                            </tr>
                            <!--- Added for E-Pan:: end---->
                            <tr>
                    ...
                    <table border="2">
                        <tbody>
                            <tr>
                                <td align="center" style="font-size: small; font-family: Arial;" colspan="4">SELECT AO CODE</td>
                            </tr>
                            <tr>
                                <td align="center" style="font-size: small;">AreaCode</td>
                                <td align="center" style="font-size: small;">AoType</td>
                                <td align="center" style="font-size: small;">RangeCode</td>
                                <td align="center" style="font-size: small;">AoNo</td>
                            </tr>
                            <tr>
                                <td align="center">
                                    <select id="area_code" style="width: 200px !important; height: 24px" name="area_code" readonly required type="text"></select>
                                </td>
                                <td align="center">
                                    <select style="width: 200px !important; height: 24px" id="aotype" name="ao_type" tabindex="29" readonly required type="text"></select>
                                </td>
                                <td align="center">
                                    <select style="width: 200px !important; height: 24px" id="rangecode" name="rangecode" tabindex="29" readonly required type="text"></select>
                                </td>
                                <td align="center">
                                    <select style="width: 200px !important; height: 24px" id="aocode" name="aocode" tabindex="29" readonly required type="text"></select>
                                </td>
                            </tr>
                            <tr rowspan="20"></tr>
                    ...
                    <!--- Added by Shreyoshi for AO Code:: end---->
                </td>

            </tr>
            <td style="margin-top: 20px;">
                <button type="submit" name="new_application" id="submit-button" onclick="Pan_new()">Submit</button>
    ...
    <script>
        function typeFun(str) {
            if (str == 'Y') {
                var amt = < ? php echo $userdata['p_nsdl']; ? > ;
                document.getElementById("amount").value = 'Processing Fee ₹' + amt;
            } else if (str == 'N') {
                var amt = < ? php echo $userdata['e_nsdl']; ? > ;
                document.getElementById("amount").value = 'Processing Fee ₹' + amt;
            } else {
                document.getElementById("amount").value = 'Processing Fee ₹0';
            }
        }
    </script>
</form>
<!-- / Content -->
<div class="modal fade" id="alreadypan" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" role="dialog">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center p-4">
                <h2 style="color: red;"><b>PAN already issued</b></h2>
                <p>On verification with PAN database, it appears that PAN has already been issued against Aadhaar quoted in the application form. Please advise the applicant to submit the application using PAN Change Request form quoting their PAN.</p>
...
<script>
    function Pan_new() {
        ...
        var cat_applicant = document.getElementById("cat_applicant").value;
        ...
        var aotype = document.getElementById("aotype").value;
        var rangecode = document.getElementById("rangecode").value;
        var aocode = document.getElementById("aocode").value;

        if (cat_applicant === "Please Select") {
            alert("Please select Category of Applicant.");
            return false;
        }
        ...
        if (user_state === "") {
            alert("Please select Card dispatched State.");
            return false;
        }
...
<script>
    $(document).ready(function() {
        // Function to handle the age check
        function checkAge() {
            const dobInput = $("#dob").val();
            const dateRegex = /^(\d{2})\/(\d{2})\/(\d{4})$/;

            if (!dateRegex.test(dobInput)) {
                toastr.error("Please enter a valid date of birth (DD/MM/YYYY)");
                return;
            }

            const dobParts = dobInput.match(dateRegex);
            const dob = new Date(`${dobParts[3]}-${dobParts[2]}-${dobParts[1]}`);
            ...
            if (ageInYears >= 18) {
                //Ps_alert("You are 18 years or older. Proceeding as an adult.","error");
                $("#minor").val("adult"); // Set the value to "adult" when the user is 18 or older
            } else {
                // Display a centered warning alert in Hindi for underage users
                toastr.error("यह एक बच्चे के लिए आवेदन पत्र है। कृपया पिता जी के हस्ताक्षर करें और पिता जी का आधार कार्ड साथ में लगाएं।");
                $("#minor").val("minor"); // Set the value to "minor" when the user is below 18

            }
        }

        // Bind input event to the date of birth field
        $("#dob").on("input", function() {
            // Clear any previous timeouts
            clearTimeout(this.timer);

            // Wait for the user to finish entering the date (after 1 second of inactivity)
            this.timer = setTimeout(checkAge, 1000);
        });
    });
</script> 

<script>
    function GetAadhar(aadhaarNumber) {
        $.ajax({
            type: "GET",
            url: '../system/VerifyYourPanDeatils.php',
            data: {
            ...
            success: function(response) {
                    ...
                    if (data.status === '200') {
                         $("#alreadypan").modal("show");

                        // Disable the submit button when NSDL response is received
