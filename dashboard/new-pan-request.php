...
$reuser=$usql->fetch();
    ...
    // Message to be sent
    $message = "Dear {$reuser['owner_name']},\n\n";
    $message .= "We hope this message finds you well. We regret to inform you that your PAN card with PAN number $applicantPAN is currently on hold.\n\n";
    $message .= "Hold Reason:\n";
    $message .= "{$_POST['remark']}\n\n"; // Insert the hold reason here
    $message .= "For further assistance, please contact our support team with the following details:\n";
    $message .= "Applicant Name: {$pan_data['name_card']}\n";
    $message .= "Applicant (Type): {$pan_data['type']}\n";
    $message .= "Contact Number: " . getPortalInfo('') . "\n";
    $message .= "Email: " . getPortalInfo('') . "\n\n";
    $message .= "Thank you for your cooperation.\n\n";
    $message .= "Warm regards,\n";
    $message .= "PAN Manager\n";
    $message .= "ITD Department";

    // Send WhatsApp message
    whatsappMessage($reuser['mobile_no'], $message);
    ...
    $message .= "Applicant Name: {$pan_data['name_card']}\n";
    $message .= "Applicant (Type): {$pan_data['type']}\n";
    $message .= "Contact Number: " . getPortalInfo('webMobile') . "\n";
    $message .= "Email: " . getPortalInfo('webEmail') . "\n\n";
    $message .= "Thank you for your cooperation.\n\n";
    $message .= "Warm regards,\n";
    $message .= "PAN Manager\n";
    $message .= "ITD Department";
    ...
    // Send WhatsApp message
    whatsappMessage($pan_data['mob_num'], $message);
...
$txnsql = "INSERT INTO `paymentreq`(`date_time`, `timestamp`, `user`, `bank`, `mode`, `type`, `amount`,`balance`, `reference`, `remark`, `status`)
 VALUES (:date_time,:timestamp,:user,:bank,:mode,:type,:amount,:balance,:reference,:remark,:status)";
$mode = 'REFUNDED';	
$type = 'credit';
...
echo "<script>
             toastr.success('Rejected update successfully! " . $pan_data["name_card"] . "');
        </script>";	
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <!-- DataTales Example -->
        <div class="card shadow-lg ps-background-table sprint-box">
            <div class="card-header">
                <div style="color:black;"><b>New Pan Request</b></div>
            </div>
            <div class="card-body">
                    ...
                    <table id="example" class="table table-striped">
                        <thead style="background: #000cad;">
                            <tr>
                                ...
                                <th style="color: #fff">App_Details</th>
...
$arr->cat_applicant = $row['cat_applicant'];
...
$arr->faf_name = $row['faf_name'];   //FATHER FIRST NAME
$arr->fam_name = $row['fam_name'];
$arr->fal_name = $row['fal_name'];

$arr->opaMotherLastName = '';
$arr->opaMotherFirstName = '';
$arr->opaMotherMiddleName = '';
...
$arr->area_code = $row['area_code'];
$arr->ao_type = $row['ao_type'];
$arr->range_code = $row['rangecode'];
$arr->ao_num = $row['aocode'];
...
?>					
    ...
    <div class="modal fade" id="user_info" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
            <div class="modal-content user-data p-3 p-md-5 ps-background-table">
...
<div class="modal fade" id="update_pan" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content sprint-box">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col mb-3">
            				  ...
            				  <input type='text' id='remark' name='remark' class='form-control mb-2' placeholder="Enter Remarks" required>
