var uri = "https://localhost:11100";  //Secure
...
function getURL() {
    var strURL = "http://localhost:8004/mfs100/"; // Default to non-secure
    try {
        var protocol = window.location.protocol;
        if (protocol === "https:") {
            strURL = "https://localhost:11100"; // Use secure if protocol is HTTPS
        }
    } catch (e) {
        console.error("Error determining protocol:", e);
    }
    return strURL;
}
