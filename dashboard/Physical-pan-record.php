          ...
          <div class="card-body">
            <div class="d-flex align-items-center mb-2 pb-1">
              ...
              <h4 class="ms-1 mb-0"><?php
                    $sql = $conn->prepare("SELECT COUNT(*) FROM nsdlpancard WHERE status = 'success'");
                    $sql->execute();
                    $count = $sql->fetchColumn();
                      echo $count;
                    ?></h4>
            </div>
            <p class="mb-1">Success Pan Card</p>
            <p class="mb-0">
          ...
          <div class="card-body">
            <div class="d-flex align-items-center mb-2 pb-1">
              ...
              <h4 class="ms-1 mb-0"><?php
                    ...
                    $sql = $conn->prepare("SELECT COUNT(*) FROM nsdlpancard WHERE remark LIKE ?");
                    $sql->execute(["A new PAN is allotted by ITD.<br>(%)"]);
                    $count = $sql->fetchColumn();
                    echo $count;
                ?></h4>
            </div>
            <p class="mb-1">NSDL Allotted PAN</p>
            <p class="mb-0">
              <small class="text-muted">than last week</small>
            </p>
          </div>
        ...
        <div class="card card-border-shadow-success h-100">
          <div class="card-body">
            <div class="d-flex align-items-center mb-2 pb-1">
              ...
              <h4 class="ms-1 mb-0"><?php
                    $sql = $conn->prepare("SELECT COUNT(*) FROM nsdlpancard WHERE status = 'PROCESS'");
                    $sql->execute();
                    $count = $sql->fetchColumn();
                      echo $count;
                    ?></h4>
            </div>
            <p class="mb-1">Under Process</p>
            <p class="mb-0">
              <small class="text-muted">than last week</small>
            </p>
          </div>
        ...
        <div class="card card-border-shadow-danger h-100">
          <div class="card-body">
            <div class="d-flex align-items-center mb-2 pb-1">
              ...
              <h4 class="ms-1 mb-0"><?php
                    $sql = $conn->prepare("SELECT COUNT(*) FROM nsdlpancard WHERE status = 'rejected'");
                    $sql->execute();
                    $count = $sql->fetchColumn();
                      echo $count;
                    ?></h4>
            </div>
            <p class="mb-1">Recjected</p>
            <p class="mb-0">
              <small class="text-muted">than last week</small>
            </p>
          </div>
